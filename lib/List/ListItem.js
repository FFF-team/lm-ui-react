    ...
    ListItem.prototype.render = function render() {
        ...
        if (children) return _react2.default.createElement(
            ...
            _react2.default.createElement(
                'div',
                { className: 'lm-ui-list-item-children' },
        ...
        if (rightArrow) {
            // 暂时不能配置颜色大小等
            this.pushElement(contentChildren, _react2.default.createElement('i', { className: 'lm-ui-icon lm-icon-link' }), Object.assign({}, styles.rightArrow), {});
        }
...
ListItem.propTypes = {
    ...
    rightArrow: _react2.default.PropTypes.bool
};
