...
var propTypes = {
	...
	vaildate: _propTypes2.default.object,
	validateData: _propTypes2.default.object,
	cleanBtn: _propTypes2.default.shape({

		state: _propTypes2.default.bool,
		cleanFun: _propTypes2.default.func
...
var Input = function (_React$Component) {
   ...
   */
		...
		setTimeout(function () {
			//因为是异步执行，需要判断实例是否被移除
			if (_this2.props.type === 'input' && !_this2.inputDom || _this2.props.type === 'textarea' && !_this2.textareaDom) {
   ...
   */
	...
	Input.prototype.renderInput = function renderInput() {
		...
		return _react2.default.createElement(
			'div',
			{ className: 'lm-ui-input-wrap', ref: function ref(dom) {
					_this3.inputDom = dom;
				} },
			preffix && preffix,
	...
	Input.prototype.renderTextarea = function renderTextarea() {
		...
		return _react2.default.createElement(
			'div',
			{ className: 'lm-ui-textarea-wrap', ref: function ref(dom) {
					_this4.textareaDom = dom;
				} },
