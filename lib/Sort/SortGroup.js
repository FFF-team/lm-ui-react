...
var SortGroup = function (_React$Component) {
    ...
    SortGroup.prototype.componentDidMount = function componentDidMount() {
        ...
        this.setState({
            children: this.props.children.map(function (child, index) {
                ...
                var childName = child.props.name || 'sort_' + index;
                var sortType = child.props._type;
                var initActiveItem = child.props.initActiveItem;

                _this2.collectTabInfo(childName, initActiveItem || null, sortType);
                return _react2.default.cloneElement(child, {
                    open: _this2.getInitOpen(sortType, initActiveItem),
                    key: index,
                    name: childName
                });
            })
    ...
    SortGroup.prototype.getInitOpen = function getInitOpen(sortType, initData) {
    ...
    SortGroup.prototype.collectTabInfo = function collectTabInfo(name, initActiveItem, sortType) {
