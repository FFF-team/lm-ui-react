...
var Carousel = (0, _createReactClass2.default)({
	...
	propTypes: {
		...
		width: _propTypes2.default.oneOfType([//给定宽度

		_propTypes2.default.string, _propTypes2.default.number]),
		height: _propTypes2.default.oneOfType([//给定高度

		_propTypes2.default.string, _propTypes2.default.number]),

		slideIndex: _propTypes2.default.number, //当前所处焦点
		swipeSpeed: _propTypes2.default.number, //切换比例
		speed: _propTypes2.default.number, //切换时间
		easing: _propTypes2.default.string, //线性动画效果

		autoplay: _propTypes2.default.bool, //自动播放
		autoplayInterval: _propTypes2.default.number, //自动播放时间间隔

		beforeSlide: _propTypes2.default.func, //slider event hook fun
		afterSlide: _propTypes2.default.func, //slider event hook fun

		arrow: _propTypes2.default.bool, //是否显示左右箭头
		dots: _propTypes2.default.bool, //是否显示面板指示点
	...
	resizeDimensions: function resizeDimensions() {
		var _this2 = this;
		...
		if (index >= childrenCount || index < 0) {
			...
			if (index >= childrenCount) {
				...
				return this.setState({
					...
					_this4.animateSlide(null, null, _this4.getTargetLeft(null, index), function () {
						_this4.animateSlide(null, 0.01);
						_this4.props.afterSlide(endSlider);
						_this4.resetAutoplay();
					});
				});
			}
	...
	formatChildren: function formatChildren(children) {
		...
		return _react2.default.Children.map(children, function (child, index) {
			...
			return _react2.default.createElement(
				'li',
				{ className: 'carousel-item', style: _this6.getSlideStyles(index, positionValue), key: index },
				child
			);
		});
	},
	render: function render() {
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				...
				this.props.dots && _react2.default.createElement(_decorate.CarouselDot, {
					currentSlide: this.state.currentSlide,
					dotCount: _react2.default.Children.count(this.props.children),
					clickHandler: this.switchCurrentSlide }),
				this.props.page && _react2.default.createElement(_decorate.CarouselPage, {
					currentSlide: this.state.currentSlide,
					pageTotel: _react2.default.Children.count(this.props.children) })
			)
		);
	}
});
